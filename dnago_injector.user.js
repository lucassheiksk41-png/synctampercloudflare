...
(function() {
    ...
    function criarPainelHub() {
        ...
        const wrapper = document.createElement('div'); wrapper.id = 'omini-wrapper-dnago';
        ...
        const painel = document.createElement('div'); painel.id = 'omini-hub-panel-dnago';
        ...
        style.innerHTML = `
            ...
            #omini-hub-panel-dnago div { height: auto !important; max-height: none !important; min-height: 0 !important; }
            #omini-hub-panel-dnago input, #omini-hub-panel-dnago select, #omini-hub-panel-dnago button {
        ...
        painel.innerHTML = `
            <div id="hub-header" style="background: linear-gradient(90deg, #2e1065, #6b21a8); font-weight: 900; font-size: 11px; border-radius: 7px 7px 0 0; text-align: center; color: #f97316; text-shadow: 0 0 5px #f97316;">
                <span>🧬 DNA-GO HUB v6.4 (ARMADURA)</span>
            </div>
        ...
        const bolha = document.createElement('div'); bolha.id = 'omini-hub-bolha-dnago';
        ...
        bolha.onclick = () => {
            ...
            } else { painel.style.display = 'none'; bolha.innerHTML = `<span style="font-size: 20px; filter: drop-shadow(0 0 6px #f97316);">🧬</span>`; bolha.style.background = `linear-gradient(135deg, #2e1065, #6b21a8)`; bolha.style.borderColor = `#f97316`; }
        };
